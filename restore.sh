...
# Load core module system
source "${SCRIPT_DIR}/lib/core.sh"

# Require runtime, session, config and report modules
core_require runtime session config report

# Load Oracle libraries (oracle.sh uses core_require internally)
core_load oracle

# Load additional Oracle modules for RMAN restore
core_load oracle_rman
...
config_load_hierarchical "restore" "/etc/restore.conf" "${SCRIPT_DIR}/../config/restore.conf" || true

# Set defaults for restore-specific variables
